...
bzw. "latex ausarbeitung" übersetzt werden muss (siehe Makefile). Die
...
ausarbeitung.bib  - Beispiel für eine BiBTeX-Datei (Literaturdatenbank)
ausarbeitung.ist  - Für Makeindex notwendig, siehe Makefile
