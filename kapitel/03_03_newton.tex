...
\label{eq:newton-aufwand-gesamt}
  & 1\,E +\sum_{i=1}^{t} \left( i\,M + E \right) +1\,E+\sum_{i=1}^{t} \left( (2^i-1)\,D+ 2^{i-1}\cdot \left( i\,A + \left( i-1 \right)\,M + 1\,D +1\,E \right) \right)\notag\\
  & = (t+2)\,E+ \sum_{i=1}^{t} \left( (2^i-1)\,D+ 2^{i-1}\cdot (i\,A+i\,M+1\,D+1\,E)\right)\notag\\
  &= 2\,E + \sum_{i=1}^t \left((2^i-1)\,D+ 2^{i-1}\cdot(i\,A+i\,M+1\,D+1\,E) +1\,E \right)
\end{align}
