...
\begin{figure}[ht]
  ...
  \end{center}
  \caption{Glättung durch Splines. Links: Streckenzug mit Hilfe von Geraden zwischen zwei Punkten. Rechts: Streckenzug mit Hilfe von kubischen Polynomen. (Daten aus \cite{c11} von \emph{Gerhard Wanner}).}
  \label{fig:cat}
\end{figure}\\
...
\begin{figure}[h]
  ...
  \end{center}
  \caption{Wert des Schlüssels. Links aus der Sicht des Empfängers $u_1$, rechts aus der Sicht des Empfängers $u_2$}
