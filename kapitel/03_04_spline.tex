...
\begin{figure}[ht]
  ...
  \end{center}
  \caption{Glättung durch Splines. Links: Streckenzug mit Hilfe von Geraden zwischen zwei Punkten. Rechts: Streckenzug mit Hilfe von kubischen Polynomen. (Daten von \emph{Gerhard Wanner}).}
  \label{fig:cat}
\end{figure}\\
