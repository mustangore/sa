...
\hspace*{0.45cm}Naor und Pinkas \cite{np00} haben auf der Suche nach dieser Antwort mit Hilfe der aus der numerischen Mathematik bekannten Polynominterpolation ein Revocation-Schema entwickelt. Ein Revocation-Schema bezeichnet eine Methode, um unerlaubten Teilnehmern aus einer bestimmten Teilnehmermenge die Möglichkeit zu verweigern, digitale Inhalte zu entschlüsseln. Dieser Prozess ist auch als \textit{User Exclusion} oder \textit{Blacklisting} bekannt.
